...
public class GracenoteWebAPI
{
    ...
    public radams.gracenote.webapi.GracenoteMetadata searchTrack(String artistName, String albumTitle, String trackTitle)
    {
        // Sanity check
    ...
    public radams.gracenote.webapi.GracenoteMetadata searchArtist(String artistName)
    {
        return this.searchTrack(artistName,  "", "");
    }

    // Queries the Gracenote service for an album.
    public radams.gracenote.webapi.GracenoteMetadata searchAlbum(String artistName, String albumTitle)
    {
